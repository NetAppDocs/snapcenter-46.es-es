...
Las configuraciones compatibles con el plugin de SnapCenter para base de datos de Oracle se enumeran en la https://imt.netapp.com/matrix/imt.jsp?components=103047;&solution=1257&isHWU&src=IMT["Herramienta de matriz de interoperabilidad de NetApp"^].
