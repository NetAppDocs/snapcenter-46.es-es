...
|===
Para modificar los detalles del puerto, consulte https://docs.netapp.com/us-en/snapcenter/admin/concept_manage_hosts.html#modify-plug-in-hosts[] [Modifique los hosts del plugin].
